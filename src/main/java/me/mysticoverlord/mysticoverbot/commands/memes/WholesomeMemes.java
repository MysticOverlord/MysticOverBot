...
public class WholesomeMemes implements ICommand {
    @Override
    public void handle(List<String> args, GuildMessageReceivedEvent event) {
    	
        WebUtils.ins.getJSONArray("https://www.reddit.com/r/wholesomememes/random.json").async(json -> {
    ...
    public String getHelp() {
        return "Gets you some wholesome memes";
    }

    @Override
    public String getInvoke() {
        return "wholesomememe";
    }
