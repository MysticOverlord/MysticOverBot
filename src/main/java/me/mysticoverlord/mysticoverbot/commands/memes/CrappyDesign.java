...
public class CrappyDesign implements ICommand {
    @Override
    public void handle(List<String> args, GuildMessageReceivedEvent event) {
    	
        WebUtils.ins.getJSONArray("https://www.reddit.com/r/CrappyDesign/random.json").async(json -> {
    ...
    public String getHelp() {
        return "Cringe at design failures";
    }
