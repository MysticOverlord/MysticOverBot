...
public class ComedyHeaven  implements ICommand {
    @Override
    public void handle(List<String> args, GuildMessageReceivedEvent event) {
    	
        WebUtils.ins.getJSONArray("https://www.reddit.com/r/comedyheaven/random.json").async(json -> {
    ...
    public String getHelp() {
        return "Gives you Comedy Heaven";
    }
