...
public class ComedyCemetery implements ICommand {
    @Override
    public void handle(List<String> args, GuildMessageReceivedEvent event) {
    	
        WebUtils.ins.getJSONArray("https://www.reddit.com/r/comedycemetery/random.json").async(json -> {
    ...
    public String getHelp() {
        return "Gives you Comedy Cemetery";
    }

    @Override
    public String getInvoke() {
        return "comedycemetery";
    }
