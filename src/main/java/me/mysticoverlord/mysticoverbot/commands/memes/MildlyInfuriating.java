...
public class MildlyInfuriating implements ICommand {
    @Override
    public void handle(List<String> args, GuildMessageReceivedEvent event) {
    	
        WebUtils.ins.getJSONArray("https://www.reddit.com/r/mildlyinfuriating/random.json").async(json -> {
    ...
    public String getHelp() {
        return "Get annoyed by r/mildlyinfuriating";
    }

    @Override
    public String getInvoke() {
        return "mildlyinfuriating";
    }
