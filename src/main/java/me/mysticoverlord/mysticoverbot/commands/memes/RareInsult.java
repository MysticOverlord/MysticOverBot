...
public class RareInsult  implements ICommand {
    @Override
    public void handle(List<String> args, GuildMessageReceivedEvent event) {
    	
        WebUtils.ins.getJSONArray("https://www.reddit.com/r/rareinsults/random.json").async(json -> {
    ...
    public String getHelp() {
        return "Retrieve some rare insults";
    }
