...
public class AdviceAnimals implements ICommand {
    @Override
    public void handle(List<String> args, GuildMessageReceivedEvent event) {
    	
        WebUtils.ins.getJSONArray("https://www.reddit.com/r/AdviceAnimals/random.json").async(json -> {
    ...
    public String getHelp() {
        return "Have some Animal Advice";
    }
