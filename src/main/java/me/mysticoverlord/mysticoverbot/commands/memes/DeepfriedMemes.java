...
public class DeepfriedMemes implements ICommand {
    @Override
    public void handle(List<String> args, GuildMessageReceivedEvent event) {
    	
        WebUtils.ins.getJSONArray("https://www.reddit.com/r/DeepFriedMemes/random.json").async(json -> {
    ...
    public String getHelp() {
        return "Gets ya some deepfried memes";
    }

    @Override
    public String getInvoke() {
        return "deepfriedmeme";
    }
