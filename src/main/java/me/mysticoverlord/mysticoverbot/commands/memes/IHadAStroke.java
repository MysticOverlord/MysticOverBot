...
public class IHadAStroke  implements ICommand {
    @Override
    public void handle(List<String> args, GuildMessageReceivedEvent event) {
    	
        WebUtils.ins.getJSONArray("https://www.reddit.com/r/ihadastroke/random.json").async(json -> {
    ...
    public String getHelp() {
        return "Have fun laughing at r/ihadastroke memes";
    }
