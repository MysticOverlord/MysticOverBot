...
public class AssholeDesign implements ICommand {
    @Override
    public void handle(List<String> args, GuildMessageReceivedEvent event) {
    	
        WebUtils.ins.getJSONArray("https://www.reddit.com/r/assholedesign/random.json").async(json -> {
    ...
    public String getHelp() {
        return "Scream at assholes for designing this";
    }

    @Override
    public String getInvoke() {
        return "assholedesign";
    }
