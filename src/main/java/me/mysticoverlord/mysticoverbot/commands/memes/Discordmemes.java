...
public class Discordmemes implements ICommand {
    @Override
    public void handle(List<String> args, GuildMessageReceivedEvent event) {
    	
    	WebUtils.ins.getJSONArray("https://www.reddit.com/r/Discordmemes/random.json").async(json -> {
    ...
    public String getHelp() {
        return "We are in discord! Why not look at discord memes?";
    }
