...
public class OneJob implements ICommand {
    @Override
    public void handle(List<String> args, GuildMessageReceivedEvent event) {
    	
        WebUtils.ins.getJSONArray("https://www.reddit.com/r/OneJob/random.json").async(json -> {
    ...
    public String getHelp() {
        return "Gets ya some r/onejob memes";
    }
